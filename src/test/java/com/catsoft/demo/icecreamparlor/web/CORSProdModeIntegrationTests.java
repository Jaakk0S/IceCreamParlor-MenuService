...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT, properties = { "dev.mode=false" })
@DirtiesContext
public class CORSProdModeIntegrationTests extends AbstractIntegrationTests {
